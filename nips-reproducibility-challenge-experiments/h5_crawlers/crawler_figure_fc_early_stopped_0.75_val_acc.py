...
source_dir = 'results/early_stopped_fc_0.75'

seeds = [0, 1, 2, 3, 4]
final_weights_inds = [13, 15, 13, 15, 11]
...
df.to_csv('nips-reproducibility-challenge-results/crawled_data_early_stopped_0.75_val_acc.csv')
